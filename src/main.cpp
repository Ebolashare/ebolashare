...
unsigned int nStakeMinAge = 60; // 60 seconds
unsigned int nStakeMaxAge = -1;           //unlimited
unsigned int nModifierInterval = 60; // time to elapse before new modifier is computed

int nCoinbaseMaturity = 5; // 5 blocks for coins to mature
...
const string strMessageMagic = "ebolashares Signed Message:\n";
...
const int DAILY_BLOCKCOUNT =  2520;
...
bool CheckDiskSpace(uint64_t nAdditionalBytes)
{
    ...
    if (nFreeBytesAvailable < nMinDiskSpace + nAdditionalBytes)
    {
        ...
        printf("*** %s\n", strMessage.c_str());
        uiInterface.ThreadSafeMessageBox(strMessage, "ebolashares", CClientUIInterface::OK | CClientUIInterface::ICON_EXCLAMATION | CClientUIInterface::MODAL);
        StartShutdown();
        return false;
    }
    return true;
