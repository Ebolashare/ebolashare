...
void ThreadGetMyExternalIP(void* parg)
{
    ...
    RenameThread("ebolashares-ext-ip");
...
void ThreadMapPort2(void* parg)
{
    ...
    if (r == 1)
    {
        ...
        string strDesc = "ebolashares " + FormatFullVersion();
#ifndef UPNPDISCOVER_SUCCESS
        /* miniupnpc 1.5 */
...
static const char *strDNSSeed[][2] = {
    {"104.131.167.157", "104.131.167.157"}, //Main ebolashares Seed Node
...
void ThreadDNSAddressSeed(void* parg)
{
    ...
    RenameThread("ebolashares-dnsseed");
...
void ThreadDumpAddress(void* parg)
{
    ...
    RenameThread("ebolashares-adrdump");
...
void ThreadOpenConnections(void* parg)
{
    ...
    RenameThread("ebolashares-opencon");
...
void ThreadMessageHandler(void* parg)
{
    ...
    RenameThread("ebolashares-msghand");
...
bool BindListenPort(const CService &addrBind, string& strError)
{
    ...
    if (::bind(hListenSocket, (struct sockaddr*)&sockaddr, len) == SOCKET_ERROR)
    {
        ...
        if (nErr == WSAEADDRINUSE)
            strError = strprintf(_("Unable to bind to %s on this computer. ebolashares is probably already running."), addrBind.ToString().c_str());
        else
...
void StartNode(void* parg)
{
    ...
    RenameThread("ebolashares-start");
