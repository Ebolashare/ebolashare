 ...
 *
 * AIM : Update exchanges last prices for EBOLA market when requested
 *
 * Overview screen will call refresh and connected using signal.
 *
 * On the overview page we are pulling current prices from the markets to show the current price for EBOLA.
 *
 */
...
/*
Mintpal
https://api.mintpal.com/v2/market/stats/EBOLA/BTC
we want to pull the info from “last_price”
https://api.mintpal.com/v2/market/stats/AUR/BTC is an example as the market EBOLA has not been created.
*/
...
https://bittrex.com/api/v1.1/public/getmarketsummary?market=btc-aur is an example as the market EBOLA has not been created.
*/
...
https://c-cex.com/t/btc-usd.json is an example as the market EBOLA has not been created.
*/
...
we need to pull info from line BTC_EBOLA
